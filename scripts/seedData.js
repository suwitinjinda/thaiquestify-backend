...
async function seedData() {
  try {
    ...
    const testUsers = [
      {
        ...
        password: '$2b$10$exampleHashedPassword', // In real app, use bcrypt
        userType: 'admin',
        partnerCode: null,
        phone: '0812345678',
        isActive: true
    ...
    console.log('\n📋 Test Data Created:');
    console.log('- Admin User: admin@thaiquestify.com');
    console.log('- Partner User: partner@gmail.com (PARTNER001)');
    console.log('- Shop User: shop@example.com');
    console.log('- 2 Shops (1 active, 1 pending)');
